...
('ric_relation_type', 'RiC Relation Type', 'ric', 'has_provenance', 'Has Provenance', '#28a745', 'fa-project-diagram', 4, 0, 1, '{"predicate":"rico:hasOrganicProvenance","inverse":"rico:isOrganicProvenanceOf","category":"provenance","domain":"Record","range":"Agent","symmetric":false}', NOW(), NOW()),
('ric_relation_type', 'RiC Relation Type', 'ric', 'held_by', 'Held By', '#ffc107', 'fa-archive', 5, 0, 1, '{"predicate":"rico:hasOrHadHolder","inverse":"rico:isOrWasHolderOf","category":"provenance","domain":"Record","range":"Agent","symmetric":false}', NOW(), NOW()),
('ric_relation_type', 'RiC Relation Type', 'ric', 'managed_by', 'Managed By', '#ffc107', 'fa-user-tie', 6, 0, 1, '{"predicate":"rico:hasOrHadManager","inverse":"rico:isOrWasManagerOf","category":"provenance","domain":"Record","range":"Agent","symmetric":false}', NOW(), NOW()),
-- Hierarchical relations
('ric_relation_type', 'RiC Relation Type', 'ric', 'includes', 'Includes', '#fd7e14', 'fa-sitemap', 7, 0, 1, '{"predicate":"rico:includesOrIncluded","inverse":"rico:isOrWasIncludedIn","category":"hierarchical","domain":"RecordSet","range":"Record","symmetric":false}', NOW(), NOW()),
('ric_relation_type', 'RiC Relation Type', 'ric', 'has_part', 'Has Part', '#fd7e14', 'fa-puzzle-piece', 8, 0, 1, '{"predicate":"rico:includesOrIncluded","inverse":"rico:isOrWasPartOf","category":"whole_part","domain":"*","range":"*","symmetric":false}', NOW(), NOW()),
('ric_relation_type', 'RiC Relation Type', 'ric', 'is_superior_of', 'Is Superior Of', '#fd7e14', 'fa-level-up-alt', 9, 0, 1, '{"predicate":"openricx:isSuperiorOf","inverse":"rico:isOrWasSubordinateTo","category":"hierarchical","domain":"Agent","range":"Agent","symmetric":false}', NOW(), NOW()),
-- Temporal relations
('ric_relation_type', 'RiC Relation Type', 'ric', 'is_successor_of', 'Is Successor Of', '#007bff', 'fa-arrow-right', 10, 0, 1, '{"predicate":"rico:isSuccessorOf","inverse":"openricx:isPredecessorOf","category":"temporal","domain":"Agent","range":"Agent","symmetric":false}', NOW(), NOW()),
('ric_relation_type', 'RiC Relation Type', 'ric', 'is_predecessor_of', 'Is Predecessor Of', '#007bff', 'fa-arrow-left', 11, 0, 1, '{"predicate":"openricx:isPredecessorOf","inverse":"rico:isSuccessorOf","category":"temporal","domain":"Agent","range":"Agent","symmetric":false}', NOW(), NOW()),
('ric_relation_type', 'RiC Relation Type', 'ric', 'follows', 'Follows', '#007bff', 'fa-fast-forward', 12, 0, 1, '{"predicate":"rico:followsInTime","inverse":"rico:precedesInTime","category":"sequential","domain":"Record","range":"Record","symmetric":false}', NOW(), NOW()),
...
('ric_relation_type', 'RiC Relation Type', 'ric', 'is_associated_with', 'Is Associated With', '#6f42c1', 'fa-link', 16, 0, 1, '{"predicate":"openricx:isAssociatedWith","inverse":"openricx:isAssociatedWith","category":"associative","domain":"*","range":"*","symmetric":true}', NOW(), NOW()),
...
('ric_relation_type', 'RiC Relation Type', 'ric', 'has_instantiation', 'Has Instantiation', '#17a2b8', 'fa-file', 22, 0, 1, '{"predicate":"rico:hasOrHadInstantiation","inverse":"rico:isOrWasInstantiationOf","category":"whole_part","domain":"Record","range":"Instantiation","symmetric":false}', NOW(), NOW()),
('ric_relation_type', 'RiC Relation Type', 'ric', 'has_derived_instantiation', 'Has Derived Instantiation', '#17a2b8', 'fa-code-branch', 23, 0, 1, '{"predicate":"rico:hasOrHadDerivedInstantiation","inverse":"rico:isOrWasDerivedFromInstantiation","category":"derivative","domain":"Instantiation","range":"Instantiation","symmetric":false}', NOW(), NOW()),
-- Family relations
('ric_relation_type', 'RiC Relation Type', 'ric', 'has_family_member', 'Has Family Member', '#28a745', 'fa-users', 24, 0, 1, '{"predicate":"rico:hasOrHadMember","inverse":"rico:isOrWasMemberOf","category":"associative","domain":"Family","range":"Person","symmetric":false}', NOW(), NOW()),
('ric_relation_type', 'RiC Relation Type', 'ric', 'is_child_of', 'Is Child Of', '#28a745', 'fa-child', 25, 0, 1, '{"predicate":"rico:isChildOf","inverse":"openricx:isParentOf","category":"associative","domain":"Person","range":"Person","symmetric":false}', NOW(), NOW()),
('ric_relation_type', 'RiC Relation Type', 'ric', 'is_sibling_of', 'Is Sibling Of', '#28a745', 'fa-people-arrows', 26, 0, 1, '{"predicate":"openricx:isSiblingOf","inverse":"openricx:isSiblingOf","category":"associative","domain":"Person","range":"Person","symmetric":true}', NOW(), NOW()),
-- Record resource relations
('ric_relation_type', 'RiC Relation Type', 'ric', 'documents', 'Documents', '#007bff', 'fa-file-alt', 27, 0, 1, '{"predicate":"rico:documents","inverse":"rico:isOrWasDescribedBy","category":"functional","domain":"Record","range":"Activity","symmetric":false}', NOW(), NOW()),
